...
import { calculateClosestGuess, formatClosestGuessMessage, generateShareText } from '../utils';
...
describe('Closest Guess Functionality', () => {
  describe('calculateClosestGuess', () => {
    ...
    it('should handle invalid inputs gracefully', () => {
      expect(calculateClosestGuess(null as unknown as number[], 1969)).toBeNull();
      expect(calculateClosestGuess([1969], 'invalid' as unknown as number)).toBeNull();
    });
  });
  ...
  describe('formatClosestGuessMessage', () => {
    ...
    it('should handle invalid data gracefully', () => {
      ...
      expect(formatClosestGuessMessage({ guess: 1969, distance: -1 }, false)).toBe('');
    });
  });
  ...
  describe('generateShareText with closest guess', () => {
    ...
    it('should handle edge cases gracefully', () => {
      ...
      const result = generateShareText(null as unknown as number[], 1969, false);
