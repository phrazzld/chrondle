...
const THEME_KEYWORDS = {
  'ancient-civilizations': [
    'olympic', 'olympics', 'rome', 'roman', 'empire', 'caesar', 'emperor', 'greece', 'greek',
    'ancient', 'bc', 'civilization', 'dynasty', 'pharaoh', 'gladiator', 'chariot', 'temple',
    'senate', 'consul', 'legion', 'barbarian', 'colosseum', 'forum', 'athens', 'sparta',
    'alexandria', 'carthage', 'hannibal', 'cleopatra', 'augustus', 'julius', 'nero'
  ],
  'science': [
    'telescope', 'microscope', 'experiment', 'theory', 'discovery', 'invention', 'laboratory',
    'scientist', 'research', 'physics', 'chemistry', 'biology', 'astronomy', 'mathematics',
    'medicine', 'vaccine', 'electricity', 'steam', 'engine', 'machine', 'technology',
    'space', 'moon', 'rocket', 'satellite', 'nuclear', 'atomic', 'quantum', 'dna',
    'evolution', 'relativity', 'gravity', 'galileo', 'newton', 'einstein', 'darwin',
    'curie', 'edison', 'tesla', 'pasteur', 'mendel'
  ],
  'art': [
    'painting', 'sculpture', 'artist', 'renaissance', 'art', 'museum', 'gallery', 'canvas',
    'portrait', 'fresco', 'masterpiece', 'style', 'movement', 'aesthetic', 'beauty',
    'creative', 'design', 'architecture', 'cathedral', 'palace', 'music', 'composer',
    'symphony', 'opera', 'literature', 'novel', 'poetry', 'theater', 'drama',
    'leonardo', 'michelangelo', 'raphael', 'picasso', 'mozart', 'beethoven', 'shakespeare',
    'mona lisa', 'sistine', 'louvre', 'florence', 'venice', 'paris'
  ],
  'conflict': [
    'war', 'battle', 'army', 'military', 'soldier', 'general', 'siege', 'invasion',
    'revolution', 'rebellion', 'civil war', 'world war', 'conflict', 'combat', 'victory',
    'defeat', 'conquest', 'occupation', 'resistance', 'uprising', 'coup', 'massacre',
    'assassination', 'terrorism', 'weapon', 'bomb', 'gun', 'cannon', 'sword', 'shield',
    'napoleon', 'hitler', 'stalin', 'churchill', 'wellington', 'waterloo', 'gettysburg',
    'pearl harbor', 'normandy', 'd-day', 'blitzkrieg', 'holocaust', 'auschwitz'
  ]
};
...
export function getThemeMetadata(): Record<Theme, ThemeMetadata> {
  ...
  return {
    'ancient-civilizations': {
      ...
      description: 'Explore the foundations of human civilization, from the first Olympics to the fall of Rome',
      icon: '🏛️',
      color: '#8B4513',
    ...
    'general': {
      ...
      description: 'Important events that defined their eras across all aspects of human experience',
      icon: '📅',
      color: '#696969',
